...
| 1:55–2:25 | Sair, entrar como Administrador (`admin@reqaudit.com` / `12345678`) → Não conformidades → Verificar prazos → NC-001 | “A rotina diária verifica os prazos às oito horas. Este botão executa a mesma verificação. Após dois dias de atraso, a NC chega ao nível dois, comunicando responsável, auditor e líder.” |
